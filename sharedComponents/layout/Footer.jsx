...
const Footer = () => {
    return (
        <footer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 pt-10 md:pt-14 gap-8 md:gap-4 w-full bg-main-green text-main-beige p-6 md:p-8 relative z-20">
            {/* Logo Section */}
            <div className="flex justify-center sm:justify-start items-center mb-4 sm:mb-0">
                {/* Adjust logo size for responsiveness. max-h-24 for larger screens, max-h-20 for smaller ones. */}
                <img src="/images/logo.png" alt="SHCC Logo" className="max-h-20 sm:max-h-24 object-contain" />
            </div>

            {/* Information Section */}
            <div className="text-center sm:text-left">
                <h2 className="text-secondary-green font-bold text-lg md:text-xl mb-4">
                    Information
                </h2>
                <ul className="flex flex-col space-y-3">
                    <li className="hover:text-secondary-green duration-300 ease-in-out text-sm md:text-base">
                        <a href="/">Smart Healthcare City</a>
                    </li>
                    <li className="hover:text-secondary-green duration-300 ease-in-out text-sm md:text-base">
                        <a href="/">Faculty of Medical Science</a>
                    </li>
                    <li className="hover:text-secondary-green duration-300 ease-in-out text-sm md:text-base">
                        <a href="/">UM6P Hospitals</a>
                    </li>
                    <li className="hover:text-secondary-green duration-300 ease-in-out text-sm md:text-base">
                        <a href="/">ISSB Institute</a>
                    </li>
                    <li className="hover:text-secondary-green duration-300 ease-in-out text-sm md:text-base">
                        <a href="/">Biotech Park</a>
                    </li>
                </ul>
            </div>
            ...
            <div className="text-center sm:text-left">
                ...
                <ul className="flex flex-col space-y-3">
                    <li className="hover:text-secondary-green duration-300 ease-in-out text-sm md:text-base">
                        Lot 660, Hay Moulay Rachid <br /> Ben Guerir, 43150, Morocco
                    </li>
                    <li className="hover:text-secondary-green duration-300 ease-in-out text-sm md:text-base">
                        <a href="tel:+212525073100"> +212 525 073 100</a>
                    </li>
                    <li className="hover:text-secondary-green duration-300 ease-in-out text-sm md:text-base">
                        <a href="mailto:contact@um6p.ma">contact@um6p.ma</a>
                    </li>
                </ul>
            </div>
            ...
            <div className="text-center sm:text-left">
                ...
                <ul className="flex flex-row justify-center sm:justify-start space-x-4">
                    {/* Facebook Icon */}
                    <li>
                        <a href="https://www.facebook.com/UM6P.Officiel" target="_blank" rel="noopener noreferrer" className="hover:text-secondary-green duration-300 ease-in-out">
                            <svg
                                className="w-7 h-7"
                                viewBox="-5 0 20 20"
                    ...
                    {/* Instagram Icon */}
                    <li>
                        <a href="https://www.instagram.com/um6p_officiel/" target="_blank" rel="noopener noreferrer" className="hover:text-secondary-green duration-300 ease-in-out">
                            <svg
                                className="w-8 h-8"
                                viewBox="0 0 48 48"
                                xmlns="http://www.w3.org/2000/svg"
                    ...
                    {/* LinkedIn Icon */}
                    <li>
                        <a href="https://www.linkedin.com/school/um6p/" target="_blank" rel="noopener noreferrer" className="hover:text-secondary-green duration-300 ease-in-out">
                            <svg
                                className="w-8 h-8"
                                viewBox="0 0 24 24"
                                fill="none"
                    ...
                    {/* YouTube Icon */}
                    <li>
                        <a href="https://www.youtube.com/channel/UC-oQe3Q7Z5X4f6j8f-2f7gA" target="_blank" rel="noopener noreferrer" className="hover:text-secondary-green duration-300 ease-in-out">
                            <svg
                                className="w-8 h-8"
                                viewBox="0 -3 20 20"
                                xmlns="http://www.w3.org/2000/svg"
