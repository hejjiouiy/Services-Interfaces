...
// File: /home/youssef/Documents/Pojects/Services-Interfaces/sharedComponents/layout/header.jsx
        ...
        <header className="mt-14 bg-main-beige w-[95%]">
            <div className="grid grid-cols-2 gap-4  ">
                ...
                <div className="flex justify-end w-full">
                    ...
                    <svg className="h-12.5 mr-0" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#b0b0b0"><g id="SVGRepo_bgCarrier" stroke-width="0">
                    ...
                    <span className="text-main-beige ml-[-20px] rounded-full bg-red-600 px-1.5 py-0.5 text-xs h-fit ">5</span>
                </div>
            </div>
