export const featuresData = [
    {
        ...
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="currentColor" viewBox="0 0 16 16" className="text-white">
    ...
    },
    {
        ...
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="white" className="bi bi-calendar3" viewBox="0 0 16 16">
    ...
    },
    {
        ...
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="white" className="bi bi-cart3" viewBox="0 0 16 16">
