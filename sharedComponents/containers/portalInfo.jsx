...
const features = [
    {
        ...
        gradient: "bg-gradient-to-br from-[#5D8736] to-[#00543F]",
        link: "/Services",
    ...
    },
    {
        ...
        gradient: "bg-gradient-to-tr from-[#00543F] to-[#5A7E76]",
        link: "/Events",
    ...
    },
    {
        ...
        gradient: "bg-gradient-to-r from-[#5A7E76]  to-[#00543F]",
        link: "/Purchase",
    ...
    },
    {
        ...
        gradient: "bg-gradient-to-bl from-[#00543F]  to-[#809D3C]",
        link: "/warehouse",
