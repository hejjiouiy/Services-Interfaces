...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      {/* Partie gauche: Image et overlay avec texte */}
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              <div className="flex justify-between mb-2">
                ...
                <Link href="/forgot-password" className="text-sm text-main-green hover:underline">
                  Mot de passe oublié?
                </Link>
              </div>
              <input
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-600">
              ...
              <Link href="/register" className="text-main-green hover:underline font-medium">
                S'inscrire
              </Link>
            </p>
          </div>
